...
var LazyImg = /*#__PURE__*/function (_React$Component) {
  _inherits(LazyImg, _React$Component);

  var _super = _createSuper(LazyImg);
  ...
  function LazyImg(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "imgRef", /*#__PURE__*/_react.default.createRef());
